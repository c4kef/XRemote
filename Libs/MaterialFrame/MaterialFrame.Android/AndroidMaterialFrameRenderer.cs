...
namespace Sharpnado.MaterialFrame.Droid
{
    ...
    public partial class AndroidMaterialFrameRenderer : FrameRenderer
    {
        ...
        private void SetAcrylicTheme()
        {
            ...
            {
                System.Console.WriteLine($"{DateTime.Now:MM-dd H:mm:ss.fff} | Sharpnado.MaterialFrame | WARNING | The Acrylic glow is only supported on android API 23 or greater (starting from Marshmallow)");
            }
